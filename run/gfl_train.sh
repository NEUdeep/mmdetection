...
# ./tools/dist_train.sh configs/detectors/detectors_cascade_rcnn_r50_1x_coco.py 8
./tools/dist_train.sh my/gfl_x101_32x4d_fpn_dconv_c4-c5_mstrain_2x_coco.py 8 --resume-from work_dirs/gfl_x101_32x4d_fpn_dconv_c4-c5_mstrain_2x_coco/epoch_3.pth
